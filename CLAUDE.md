...
| `spin-recover.mjs` | After a spin-out, is the kart pointing down the track or back up it? Heading error in degrees against the track direction, across every stun length the game deals. |
